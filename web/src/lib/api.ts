...
export const api = {
  ...
  async toggleCompetition(traderId: string, showInCompetition: boolean): Promise<void> {
    ...
    if (!result.success) throw new Error('Failed to update arena display settings')
  },
  ...
  async getExchangeConfigs(): Promise<Exchange[]> {
    ...
    if (!result.success) throw new Error('Failed to get exchange config')
    return result.data!
  },
  ...
  async updateExchangeConfigs(
    ...
    if (!result.success) throw new Error('Failed to update exchange config')
  },
  ...
  async getDecisions(traderId?: string): Promise<DecisionRecord[]> {
    ...
    if (!result.success) throw new Error('Failed to get decisions')
    return result.data!
  },
  ...
  async getEquityHistory(traderId?: string): Promise<any[]> {
    ...
    if (!result.success) throw new Error('Failed to get equity history')
    return result.data!
  },
  ...
  async getEquityHistoryBatch(traderIds: string[], hours?: number): Promise<any> {
    ...
    if (!result.success) throw new Error('Failed to get batch equity history')
    return result.data!
  },
  ...
  async getStrategies(): Promise<Strategy[]> {
    ...
    if (!result.success) throw new Error('Failed to get strategy list')
  ...
  async getDebates(): Promise<DebateSession[]> {
    ...
    if (!result.success) throw new Error('Failed to get debate list')
    return Array.isArray(result.data) ? result.data : []
  },
  ...
  async getDebatePersonalities(): Promise<DebatePersonalityInfo[]> {
    ...
    if (!result.success) throw new Error('Failed to get AI personality list')
    return result.data!
  },
  ...
  async getPositionHistory(traderId: string, limit: number = 100): Promise<PositionHistoryResponse> {
    ...
    if (!result.success) throw new Error('Failed to get position history')
    return result.data!
  },
}
